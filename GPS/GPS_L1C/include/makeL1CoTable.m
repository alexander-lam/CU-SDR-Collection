function caCodesTable = makeL1CoTable(PRN,settings)
...
samplesPerCode = round(settings.samplingFreq * 18);

%--- Find time constants --------------------------------------------------
ts = 1/settings.samplingFreq;   % Sampling period in sec
tc = 0.01;  % C/A chip period in sec

%--- Generate CA code for given PRN -----------------------------------
caCode = generateL1CoCode(PRN);
